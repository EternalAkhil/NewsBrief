...
const Business = () => {
    ...
    useEffect(() => {
        const getnews = async () => {
            const res = await fetchNewsEvery("business");
    ...
    return (
        <>
        <h1 className='text-3xl font-bold mb-4 mt-8 ml-8'>Business</h1>
            <section id='business' className='grid p-4 lg:grid-cols-3 grid-cols-1 lg:gap-8 gap-4'>
