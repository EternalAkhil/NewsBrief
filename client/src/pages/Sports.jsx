...
const Sports = () => {
    ...
    useEffect(() => {
        const getnews = async () => {
            ...
            const res = await fetchNewsEvery("sports");
    ...
    return (
        <>
        <h1 className='text-3xl font-bold mb-4 mt-8 ml-8'>Sports</h1>
            <section id='sports' className='grid p-4 lg:grid-cols-3 grid-cols-1 lg:gap-8 gap-4'>
