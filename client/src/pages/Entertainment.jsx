...
const Entertainment = () => {
    ...
    useEffect(() => {
        const getnews = async () => {
            ...
            const res = await fetchNewsEvery("entertainment");
    ...
    return (
        <>
        <h1 className='text-3xl font-bold mb-4 mt-8 ml-8'>Entertainment</h1>
            <section id='entertainment' className='grid p-4 lg:grid-cols-3 grid-cols-1 lg:gap-8 gap-4'>
